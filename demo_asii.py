...
# -*- coding: utf-8 -*-
"""
Demo script: Menjalankan kalkulasi dengan ASII.JK menggunakan yfinance
"""
...
def demo_graham_asii():
    """Demo: Kalkulasi Graham Number untuk ASII.JK menggunakan yfinance"""

    judul("DEMO: METODE GRAHAM DENGAN ASII.JK")
